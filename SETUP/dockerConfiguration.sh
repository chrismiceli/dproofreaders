...
_CODE_DIR=/home/$USER/public_html/c
...
_PHPBB_TABLE_PREFIX=dp_phpbb3.phpbb
...
_SITE_NAME='DP Development Site'
...
_ARCHIVE_PROJECTS_DIR=$base_dir/projects.archive
...
_GENERAL_HELP_EMAIL_ADDR=dphelp@pgdp.org
...
_FORUMS_TEAMS_IDX=17
# Each team gets an automatically-created discussion topic in this forum

_FORUMS_PROJECT_WAITING_IDX=4
_FORUMS_PROJECT_AVAIL_IDX=5
_FORUMS_PROJECT_PP_IDX=6
_FORUMS_PROJECT_POSTED_IDX=7
...
_FORUMS_PROJECT_DELETED_IDX=18
_FORUMS_PROJECT_COMPLETED_IDX=18
# Projects that are deleted or completed and not posted (rare)
# have a forum of their own. Consider putting these in the same
# hidden forum.

_FORUMS_GENERAL_IDX=9
_FORUMS_BEGIN_SITE_IDX=14
_FORUMS_BEGIN_PROOF_IDX=15
_FORUMS_CONTENT_PROVIDERS_IDX=11
_FORUMS_POST_PROCESSORS_IDX=12
...
_COOKIE_ENCRYPTION_KEY='akdgao7wnkezqo390akdlal'
